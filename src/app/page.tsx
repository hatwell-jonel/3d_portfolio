...
// {/* Diagonal Line with Rotated Text Labels */}
// 				<div className="absolute inset-0 pointer-events-none z-10">
// 				{/* Diagonal Line */}
// 				<div
// 					className="absolute h-[141.42%] w-0.5 bg-linear-to-b from-transparent via-[#ff6b6b] to-transparent origin-top-left"
// 					style={{
// 						top: "0",
// 						left: "0",
...
// 				<div
// 					className={`absolute top-[63%] left-[-14%] transition-all duration-500 ${
// 					hoveredSide === "3d"
// 						? "scale-110 drop-shadow-[0_0_30px_rgba(255,107,107,1)]"
// 						: "scale-100 drop-shadow-[0_0_15px_rgba(255,107,107,0.5)]"
// 					}`}
// 					style={{
// 					transform: hoveredSide === "3d" ? "rotate(-65deg) scale(1.1)" : "rotate(-67deg) scale(1)",
// 					transformOrigin: "center",
// 					}}
// 				>
// 					<p className="text-3xl font-bold text-[#ff6b6b] whitespace-nowrap">
...
// 						? "scale-110 drop-shadow-[0_0_30px_rgba(255,107,107,1)]"
// 						: "scale-100 drop-shadow-[0_0_15px_rgba(255,107,107,0.5)]",
// 						stylePositon.classViewText
// 					)}
// 					style={{
// 						transform: hoveredSide === "2d" ? "rotate(-68deg) scale(1.1)" : "rotate(-68deg) scale(1)",
// 						transformOrigin: "center",
// 					}}
// 				>
// 					<p className="text-3xl font-bold text-[#0a0a0a] whitespace-nowrap">Classic View</p>
// 				</div>
// 				</div>